  ...
  return (
    ...
    >
      ...
      <div className="px-5 py-4 flex items-center justify-between" style={{ borderBottom: '1px solid var(--border)' }}>
        <Link href="/dashboard" onClick={handleNavClick} className="flex items-center gap-3 logo-wag group">
          <div
          ...
          <div className="min-w-0">
            <div className="font-display font-extrabold text-lg leading-none" style={{ color: 'var(--primary)' }}>
              Bingo
            </div>
      ...
      <nav className="flex-1 px-3 py-4 space-y-0.5 overflow-y-auto">
        {nav.map(({ href, icon: Icon, label }) => {
          ...
          return (
            ...
            >
              <Icon size={18} strokeWidth={2} className="shrink-0 transition-transform duration-150 group-hover:scale-110" />
              {label}
            </Link>
          )
        })}
      ...
      <div className="px-3 py-4" style={{ borderTop: '1px solid var(--border)' }}>
        ...
        <button
          ...
          className="w-full flex items-center gap-2 px-3 py-2.5 rounded-xl text-sm font-semibold transition-all min-h-[44px]"
